...
--
-- Databáza: `web_sport_dev1`
--
CREATE DATABASE IF NOT EXISTS `web_sport_dev1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `web_sport_dev1`;
...
CREATE TABLE `duel` (
  ...
  `state` enum('SCHEDULED','ONGOING','FINISHED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `duel` (`id`, `starting_time`, `state`, `stage_id`, `tournament_id`, `roster1_id`, `roster2_id`) VALUES
(1, '2025-04-05 13:00:00', 'FINISHED', 5, 1, 1, 3),
...
INSERT INTO `goal` (`player_id`, `duel_id`, `own_goal_count`, `goal_count`) VALUES
(1, 1, 1, 1),
(2, 1, 0, 2),
(4, 1, 0, 3),
(5, 2, 0, 2);
...
CREATE TABLE `organization` (
  `id` int NOT NULL,
  `short_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `organization` (`id`, `short_name`, `full_name`, `city_id`) VALUES
(1, 'UPeCe BA', 'Univerzitné pastoračné centrum svätého Jozefa Freinademetza (UPeCe BA)', 2),
...
INSERT INTO `player` (`id`, `jersey_number`, `first_name`, `last_name`) VALUES
(1, 7, 'Marek', 'Kormoš'),
...
INSERT INTO `roster` (`id`, `name`, `tournament_id`, `organization_id`) VALUES
(1, 'Beskyho anjelici', 1, 1),
...
CREATE TABLE `stage` (
  `id` int NOT NULL,
  `code` enum('group','quarterfinals','semifinals','finals','third_place') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `stage` (`id`, `code`, `name`, `order_index`) VALUES
(1, 'group', 'Skupina A', 5),
(2, 'group', 'Skupina B', 6),
(3, 'group', 'Skupina C', 7),
...
INSERT INTO `tournament` (`id`, `name`, `year`, `host_city_id`, `date`) VALUES
(1, 'Medzi UPeCe Florbalový turnaj 2024 (MUF CUP)', 2024, 2, '2024-04-13'),
...
ALTER TABLE `duel`
  ...
  ADD CONSTRAINT `duel_ibfk_2` FOREIGN KEY (`roster1_id`) REFERENCES `roster` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `duel_ibfk_3` FOREIGN KEY (`roster2_id`) REFERENCES `roster` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `duel_ibfk_4` FOREIGN KEY (`stage_id`) REFERENCES `stage` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `goal`
  ...
  ADD CONSTRAINT `goal_ibfk_2` FOREIGN KEY (`duel_id`) REFERENCES `duel` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `player_roster`
  ...
  ADD CONSTRAINT `player_roster_ibfk_2` FOREIGN KEY (`roster_id`) REFERENCES `roster` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `roster`
  ...
  ADD CONSTRAINT `roster_ibfk_2` FOREIGN KEY (`organization_id`) REFERENCES `organization` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
